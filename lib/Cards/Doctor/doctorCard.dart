                       ...
                       Text(
                         ...
                         style: TextStyle(
                           ...
                           // color: reviewExists? primary : greyBorders
                             color: doctor.noOfReviews!=0? primary : greyBorders
                         ),
                       ),
                         ...
                         onTap: (){
                           Navigator.push(
                             ...
                             // MaterialPageRoute(builder: (context) => ReviewsPage(uid: review.uid))
                               MaterialPageRoute(builder: (context) => ReviewsPage(uid: doctor.uid))
                           );
                         },
                         child: Text(
                           // reviewExists? '(${review.noOfReviews} reviews)' : '(0 reviews)',
                           doctor.noOfReviews!=0? '(${doctor.noOfReviews} reviews)' : '(0 reviews)',
                           style: TextStyle(
                             fontSize: 14,
                             fontWeight: FontWeight.w400,
                             // color: reviewExists? primary : greyBorders,
