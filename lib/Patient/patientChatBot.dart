...
class _PatientChatBotState extends State<PatientChatBot> {
  ...
  Future<List<String>> fetchSuggestedQuestions() async{
    ...
    if(snapshot.exists){
      print('suggested questoions exists ++++++++++');
      Map<String, dynamic> data = snapshot.data()!;
      
      if(data.containsKey('suggested_questions')){
        print('suggested questoions exists ++++++++++5555555');
  ...
  Future<void> assignSuggestedQuestions() async{
    ...
    setState(() {
      ...
      print('${suggestedQuestion.length}88888888888');
    });
  }
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (botReply.containsKey('suggested')) {
          ...
          //  print(latestresponse+"dhiashdishdishd dhs");
        }
                    ...
                    if(suggestedQuestionsExist)
                      ListView.builder(
                          ...
                          itemBuilder: (context, index){
                            print('${suggestedQuestion.length}+***************');
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          // color: isBotReply ? Colors.grey[200] : Colors.lightBlue,
        ...
        child: Text(
            text,
          style: TextStyle(
            color: isBotReply? Colors.white : Colors.black
          ),
        ),
      ),
    );
